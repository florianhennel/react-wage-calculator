...
const HouseholdSalaryCalculator = () => {
  ...
  const contextValue: MyContextType = {
    ...
    const newMember = () => {
        const newFamilyMember = { ...defaultFamilyMember, id: familyMembers.length };
    ...
    return (
        <CurrentMemberContext.Provider value={contextValue} >
            ...
            <main className="flex justify-center mt-2">
                {familyMembers.length===0?<Skeleton className="w-1/2 rounded-lg bg-zinc-700 p-4 h-[592px]" />:<SalaryCalculator deleteCurrentFamilyMember={deleteCurrentFamilyMember} />}
